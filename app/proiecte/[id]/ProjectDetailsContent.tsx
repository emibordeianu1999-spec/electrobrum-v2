              ...
              <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
                  <div className="lg:col-span-2">
                    <h2 className="text-3xl md:text-4xl font-black text-gray-900 dark:text-white mb-8 uppercase italic tracking-tighter">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="p-10 rounded-[2rem] bg-amber-500/5 border border-amber-500/10">
                        <h3 className="font-black text-amber-500 uppercase tracking-widest text-sm mb-4">
                          Provocarea
                        </h3>
                        <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                          Optimizarea spațiului disponibil pe acoperiș pentru a
                          atinge puterea instalată dorită, menținând în același
                          timp estetica locuinței și eficiența maximă.
                        </p>
                      </div>
                      <div className="p-10 rounded-[2rem] bg-green-500/5 border border-green-500/10">
                        <h3 className="font-black text-green-500 uppercase tracking-widest text-sm mb-4">
                          Rezultatul
                        </h3>
                        <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                          O reducere de peste 85% a facturilor de energie
                          electrică și o creștere semnificativă a valorii
                          proprietății pe piața imobiliară.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="lg:col-span-1">
                    <div className="sticky top-40 p-10 rounded-[2.5rem] bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-800">
                      <h3 className="text-xl font-black mb-8 uppercase italic tracking-tight">
                        Rezumat Tehnic
                      </h3>
                      ...
                      <Link
                        href="/contact"
                        className="mt-10 w-full inline-flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-600 text-white px-6 py-4 rounded-xl font-black uppercase tracking-widest transition-all shadow-lg shadow-amber-500/20"
                      >
              ...
              <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {project.gallery.map((img, idx) => (
                    <div
                      key={idx}
                      className="relative aspect-video rounded-[2rem] overflow-hidden shadow-xl border border-gray-100 dark:border-gray-800 group cursor-zoom-in"
                    >
                      <Image
                        src={img}
                        alt={`Gallery ${idx}`}
              ...
              <div className="max-w-4xl mx-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {Object.entries(project.stats).map(([key, value]) => (
                    <div
                      key={key}
                      className="flex items-center justify-between p-8 rounded-3xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 group hover:border-amber-500/30 transition-colors"
                    >
                      ...
                      <span className="font-bold text-gray-900 dark:text-white text-right text-lg">
                        {value}
                      </span>
                    </div>
                  ))}
                ...
                <div className="mt-16 p-12 rounded-[3rem] bg-gray-950 text-white text-center relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="text-3xl md:text-4xl font-black mb-6 uppercase tracking-tighter italic">
                      Performanță Garantată
                    </h3>
                    <p className="text-gray-400 mb-10 max-w-xl mx-auto text-lg">
                      Fiecare componentă este selectată pentru a asigura cel mai
                      bun randament pe termen lung și o durată de viață de peste
                      25 de ani.
                    </p>
                    <Link
                      href="/contact"
                      className="inline-flex items-center gap-3 bg-amber-500 hover:bg-amber-600 text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest transition-all shadow-2xl shadow-amber-500/40"
                    >
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-4xl md:text-6xl font-black mb-8 leading-tight tracking-tighter uppercase italic">
                Pregătit să{" "}
                <span className="text-amber-500 not-italic">Începem</span>?
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-400 mb-12 leading-relaxed">
                Fie că este vorba de un sistem rezidențial sau industrial,
                suntem aici să îți oferim cea mai bună consultanță și execuție
                din piață.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-16">
                ...
                <div className="flex items-center gap-5 p-8 rounded-3xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-xl font-bold text-gray-900 dark:text-white truncate max-w-[180px] md:max-w-none">
                      {CONTACT_INFO.email}
                    </div>
                  </div>
                </div>
